...
// تهيئة البيانات
if (!isset($_SESSION['salary_data'])) {
    $_SESSION['salary_data'] = [];
}
if (!isset($_SESSION['stocks_data'])) {
    $_SESSION['stocks_data'] = [];
}
if (!isset($_SESSION['investment_plan'])) {
    $_SESSION['investment_plan'] = [];
}
...
<body>
    <div class="container">
        <div class="header">
            ...
            <a href="private_page.php?logout=1" class="logout-btn">🚪 تسجيل الخروج</a>
        </div>
        ...
        <div class="content-area">
            ...
            <div id="salary-tab" class="tab-content active">
                <div class="summary-cards">
                    <div class="summary-card">
                        <div class="summary-number">
                            <?php echo array_sum(array_column($_SESSION['salary_data'], 'amount')); ?>
                        </div>
                        <div class="summary-label">إجمالي الراتب</div>
                    </div>
                    <div class="summary-card">
                        <div class="summary-number"><?php echo count($_SESSION['salary_data']); ?></div>
                ...
                <table class="data-table">
                    ...
                    <tbody>
                        <?php foreach ($_SESSION['salary_data'] as $item): ?>
                        <tr>
                        ...
                        <tr class="total-row">
                            ...
                            <td><?php echo number_format(array_sum(array_column($_SESSION['salary_data'], 'amount')), 2); ?> ريال</td>
                        </tr>
                    </tbody>
                </table>
            </div>
            ...
            <div id="stocks-tab" class="tab-content">
                <div class="summary-cards">
                    <div class="summary-card">
                        <div class="summary-number">
                            <?php echo array_sum(array_column($_SESSION['stocks_data'], 'total')); ?>
                        </div>
                        <div class="summary-label">إجمالي الاستثمار</div>
                    </div>
                    <div class="summary-card">
                        <div class="summary-number"><?php echo count($_SESSION['stocks_data']); ?></div>
                ...
                <table class="data-table">
                    ...
                    <tbody>
                        <?php foreach ($_SESSION['stocks_data'] as $stock): ?>
                        <tr>
                            ...
                            <td><?php echo number_format($stock['total'], 2); ?> ريال</td>
                            <td><?php echo htmlspecialchars($stock['date']); ?></td>
                        </tr>
                        <?php endforeach; ?>
                        <tr class="total-row">
                            <td colspan="4">الإجمالي</td>
                            <td><?php echo number_format(array_sum(array_column($_SESSION['stocks_data'], 'total')), 2); ?> ريال</td>
                        </tr>
                    </tbody>
                </table>
            </div>
            ...
            <div id="plan-tab" class="tab-content">
                <div class="summary-cards">
                    <div class="summary-card">
                        <div class="summary-number">
                            <?php echo array_sum(array_column($_SESSION['investment_plan'], 'target_amount')); ?>
                        </div>
                        <div class="summary-label">إجمالي الأهداف</div>
                    </div>
                    <div class="summary-card">
                        <div class="summary-number"><?php echo count($_SESSION['investment_plan']); ?></div>
                ...
                <table class="data-table">
                    ...
                    <tbody>
                        <?php foreach ($_SESSION['investment_plan'] as $plan): ?>
                        <tr>
                        ...
                        <tr class="total-row">
                            ...
                            <td><?php echo number_format(array_sum(array_column($_SESSION['investment_plan'], 'target_amount')), 2); ?> ريال</td>
                        </tr>
                    </tbody>
                </table>
            </div>
